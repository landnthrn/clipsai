...
DEFAULT_COMMUNITY_MEDIAPIPE_FACE_DETECT_MODEL_SELECTION = 1
DEFAULT_MEDIAPIPE_FACE_DETECT_MIN_DETECTION_CONFIDENCE = 0.5
DEFAULT_COMMUNITY_MEDIAPIPE_FACE_DETECT_MIN_DETECTION_CONFIDENCE = 0.3
...
DEFAULT_MEDIAPIPE_FACE_DETECT_MODEL_SELECTIONS_BY_DIARIZATION_MODEL = {
    DEFAULT_DIARIZATION_MODEL: DEFAULT_MEDIAPIPE_FACE_DETECT_MODEL_SELECTION,
    "community-1": DEFAULT_COMMUNITY_MEDIAPIPE_FACE_DETECT_MODEL_SELECTION,
}

DEFAULT_MEDIAPIPE_FACE_DETECT_CONFIDENCES_BY_DIARIZATION_MODEL = {
    DEFAULT_DIARIZATION_MODEL: DEFAULT_MEDIAPIPE_FACE_DETECT_MIN_DETECTION_CONFIDENCE,
    "community-1": DEFAULT_COMMUNITY_MEDIAPIPE_FACE_DETECT_MIN_DETECTION_CONFIDENCE,
}
...
def get_default_mediapipe_face_detect_model_selection(
    diarization_model: str | None = None,
) -> int:
    """
    Return the default MediaPipe face detector model for one diarization mode.
    """
    if diarization_model is None:
        return DEFAULT_MEDIAPIPE_FACE_DETECT_MODEL_SELECTION
    return DEFAULT_MEDIAPIPE_FACE_DETECT_MODEL_SELECTIONS_BY_DIARIZATION_MODEL.get(
        diarization_model,
        DEFAULT_MEDIAPIPE_FACE_DETECT_MODEL_SELECTION,
    )


def get_default_mediapipe_face_detect_min_detection_confidence(
    diarization_model: str | None = None,
) -> float:
    """
    Return the default MediaPipe face detector confidence for one diarization mode.
    """
    if diarization_model is None:
        return DEFAULT_MEDIAPIPE_FACE_DETECT_MIN_DETECTION_CONFIDENCE
    return DEFAULT_MEDIAPIPE_FACE_DETECT_CONFIDENCES_BY_DIARIZATION_MODEL.get(
        diarization_model,
